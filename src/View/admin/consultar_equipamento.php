          ...
          <div class="card-body">
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control select2 obg" style="width: 100%;" onchange="ConsultarEquipamento()" name="tipo_filtro"
                    id="tipo_filtro">
                ...
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control select2 obg" style="width: 100%;" onchange="ConsultarEquipamento()" name="modelo_filtro"
                    id="modelo_filtro">
                    <option value="">- SEM FILTRO -</option>
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  ...
                  <div class="input-group input-group-sm" style="width: 250px;">
                    <input type="text" onkeyup="ConsultarEquipamento()" name="identificacao_filtro" id="identificacao_filtro" class="form-control float-right" placeholder="Filtrar pela identificação...">
