                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <a href="#" class="btn btn-outline-info btn-xs">Ver Mais</a>
                                                <a href="#" class="btn btn-outline-warning btn-xs">Atender</a>
                                                <a href="#" class="btn btn-outline-success btn-xs">Finalizar</a>
                                            </td>
                                            <td>(abertura)</td>
                                            <td>(funcionário)</td>
                                            <td>(equipamento)</td>
